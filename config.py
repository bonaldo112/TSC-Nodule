...
# BASE = '/usr/local/datasets/'
BASE = '/media/ronald/123E16933E167049/Detection/Code/NoduleNet-master/'
# BASE = '/media/ja/123E16933E167049/Detection/Code/NoduleNet-master/'
data_config = {
    ...
    'annos_dir': BASE + 'CSVFILES/LIDC-XML-only/tcia-lidc-xml',

    # put lung mask downloaded from LUNA16 to this path
    'lung_mask_dir': BASE + 'seg-lungs-LUNA16/seg-lungs-LUNA16',
    ...
    'roi_names': ['nodule'],
    'crop_size': [96, 96, 96],  # [128,128,128]
    'bbox_border': 8,
    'pad_value': 170,
    # 'jitter_range': [0, 0, 0],
}
...
train_config = {
    ...
    'train_set_list': ['split/train1.csv'],
    'val_set_list': ['split/val1.csv'],
    'test_set_name': 'split/val1.csv',
    'label_types': ['mask'],
...
train_config['out_dir'] = os.path.join(train_config['RESULTS_DIR'], 'TSC-Nodule' + exp_id)
